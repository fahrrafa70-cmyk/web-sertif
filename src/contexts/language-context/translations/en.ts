...
export const en: Record<string, string> = {
  ...
  'templates.validation.required': 'This field is required',
  'templates.updateError': 'Failed to update template',
  'templates.createError': 'Failed to create template',
  'templates.form.name': 'Template Name',
  'templates.form.namePlaceholder': 'Enter template name',
  'templates.form.category': 'Category',
  'templates.form.categoryPlaceholder': 'Select category',
  'templates.form.orientation': 'Orientation',
  'templates.form.orientationPlaceholder': 'Select orientation',
  'templates.form.isDualTemplate': 'Dual Template (Front & Back)',
  'templates.form.certificateImage': 'Certificate Image (Front)',
  'templates.form.scoreImage': 'Score Image (Back)',
  'templates.form.previewImage': 'Preview Image',
  'templates.form.image': 'Template Image',
  ...
  'configure.subtitle': 'Configure your template layout and fields',
  'configure.letterSpacing': 'Letter Spacing',
  ...
  'certificates.tableName': 'Name',
  'certificates.tableDescription': 'Description',
  'certificates.tableCategory': 'Category',
  'certificates.tableIssueDate': 'Issue Date',
  'certificates.tableExpiredDate': 'Expired Date',
  'certificates.tableActions': 'Actions',
  'certificates.errorTitle': 'Error Loading Certificates',
  'certificates.selectTenantTitle': 'Select Organization',
  'certificates.selectTenantMessage': 'Please select an organization to view certificates',
  'certificates.of': 'of',
  'certificates.previewTitle': 'Certificate Preview',
  'certificates.frontSide': 'Front Side',
  'certificates.backSide': 'Back Side',
  'certificates.expired': 'Expired',
  'certificates.exportPDF': 'Export to PDF',
  'certificates.exportPNG': 'Export to PNG',
  'certificates.edit': 'Edit',
  'certificates.delete': 'Delete',
  'certificates.noCertificatesTitle': 'No Certificates found',
  'certificates.exportingPDF': 'Exporting PDF...',
  'certificates.exportingPNG': 'Exporting PNG...',
  'certificates.generatingLink': 'Generating Link...',
  'certificates.expiredDate': 'Expired Date',
  ...
  'wizardGenerate.autoMappingInfo': 'Fields from your data are automatically mapped to template fields with similar names.',
