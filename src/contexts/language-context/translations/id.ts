...
export const id: Record<string, string> = {
  ...
  'templates.validation.required': 'Field ini wajib diisi',
  'templates.updateError': 'Gagal memperbarui template',
  'templates.createError': 'Gagal membuat template',
  'templates.form.name': 'Nama Template',
  'templates.form.namePlaceholder': 'Masukkan nama template',
  'templates.form.category': 'Kategori',
  'templates.form.categoryPlaceholder': 'Pilih kategori',
  'templates.form.orientation': 'Orientasi',
  'templates.form.orientationPlaceholder': 'Pilih orientasi',
  'templates.form.isDualTemplate': 'Template Dual (Depan & Belakang)',
  'templates.form.certificateImage': 'Gambar Sertifikat (Depan)',
  'templates.form.scoreImage': 'Gambar Nilai (Belakang)',
  'templates.form.previewImage': 'Gambar Pratinjau',
  'templates.form.image': 'Gambar Template',
  ...
  'configure.subtitle': 'Konfigurasi layout dan field template Anda',
  'configure.letterSpacing': 'Jarak Huruf',
  ...
  'certificates.tableNo': 'No.',
  'certificates.tableName': 'Nama',
  'certificates.tableDescription': 'Deskripsi',
  'certificates.tableCategory': 'Kategori',
  'certificates.tableIssueDate': 'Tgl Terbit',
  'certificates.tableExpiredDate': 'Kadaluarsa',
  'certificates.tableActions': 'Aksi',
  'certificates.errorTitle': 'Error Memuat Sertifikat',
  'certificates.selectTenantTitle': 'Pilih Organisasi',
  'certificates.selectTenantMessage': 'Silakan pilih organisasi untuk melihat sertifikat',
  'certificates.of': 'dari',
  'certificates.previewTitle': 'Pratinjau Sertifikat',
  'certificates.frontSide': 'Sisi Depan',
  'certificates.backSide': 'Sisi Belakang',
  'certificates.expired': 'Kadaluarsa',
  'certificates.exportPDF': 'Ekspor ke PDF',
  'certificates.exportPNG': 'Ekspor ke PNG',
  'certificates.edit': 'Edit',
  'certificates.delete': 'Hapus',
  'certificates.noCertificatesTitle': 'Sertifikat tidak ditemukan',
  'certificates.exportingPDF': 'Mengekspor PDF...',
  'certificates.exportingPNG': 'Mengekspor PNG...',
  'certificates.generatingLink': 'Membuat Link...',
  'certificates.expiredDate': 'Tanggal Kadaluarsa',
  ...
  'wizardGenerate.autoMappingInfo': 'Field dari data secara otomatis dipetakan ke field template dengan nama yang mirip.',
  ...
  'profile.fullNameRequired': 'Nama lengkap wajib diisi',
