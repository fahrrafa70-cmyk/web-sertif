...
const translations: Translations = {
  en: {
    ...
    'faq.a4': 'The process is straightforward: select or design a template, choose a category, enter recipient details, generate the certificate, and optionally send it via email. The interface provides step-by-step guidance throughout the process.',
  ...
  id: {
    ...
    'faq.a4': 'Prosesnya sederhana: pilih atau desain template, tentukan kategori, masukkan data penerima, generate sertifikat, dan kirim via email jika diperlukan. Antarmuka platform memandu Anda melalui setiap langkah.',
