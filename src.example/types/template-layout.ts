...
export interface TextLayerConfig {
  ...
  // Rich text support (inline formatting per word/character)
  // If present, overrides fontSize/fontWeight/fontFamily/color at layer level
  richText?: RichText; // Array of styled text spans
  hasInlineFormatting?: boolean; // Flag untuk indicate apakah layer punya mixed styles
}
